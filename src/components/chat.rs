    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class="flex w-screen">
                ...
                <div class="w-full h-14 border-b-4 bg-[#000435] border-gray-300 text-white"><div class="text-xl p-3">{"💬 Chat!"}</div></div>
                <div class="w-full grow overflow-auto border-b-4 bg-[#000435] border-gray-300">
                        {
                    ...
                    <div class="w-full h-14 flex px-3 items-center bg-[#F5F5DC]">
                        ...
                        <button onclick={submit} class="p-3 shadow-sm bg-blue-600 w-10 h-10 rounded-full flex justify-center items-center color-white">
                            <svg fill="#F5F5DC" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="fill-white">
